...
with SSHTunnelForwarder(('rcg-linux-ts1.rcg.sfu.ca', 22),
    ...
    for year in [2001, 2002, 2007, 2008]:
        cursor.execute("""Drop table if exists chao_draft.rank_m5p_pred_CSS_null_norm_%s_notie;""" % str(year))
        mydb.commit()
        cursor.execute("""Create table chao_draft.rank_m5p_pred_CSS_null_norm_%s_notie as
                          ...
                          FROM chao_draft.m5p_10years_CSS_null_norm_pred,
        ...
        cursor.execute("""Create table chao_draft.rank_m5p_pred_CSS_null_norm_%s_temp as
                    ...
                    FROM rank_m5p_pred_CSS_null_norm_%s_notie as t1 ,
                    chao_draft.rank_lmt_prob_CSS_null_norm_%s_notie as t2
                    where t1.id = t2.id 
                    order by lmt_prob DESC, m5p_pred DESC;""" % (str(year), str(year), str(year)))
        mydb.commit()

        cursor.execute("""Drop table if exists chao_draft.rank_m5p_pred_CSS_null_norm_%s_tied;""" % str(year))
        mydb.commit()
        cursor.execute("""Create table chao_draft.rank_m5p_pred_CSS_null_norm_%s_tied as
        ...
        cursor.execute("""Create table chao_draft.rank_m5p_pred_CSS_null_norm_%s_temp as
                  ...
                  FROM chao_draft.m5p_10years_nonzero_CSS_null_norm_pred,
                    (SELECT @curr := null, @prev := null, @rank:= 1, @i := 0) tmp_tbl
                  where DraftYear = %s
                  order by m5p_pred DESC;""" % (str(year), str(year)))
        mydb.commit()
        ...
        cursor.execute("""Drop table if exists chao_draft.rank_m5p_pred_CSS_null_norm_%s_nonzero;""" % str(year))
        mydb.commit()
        cursor.execute("""Create table chao_draft.rank_m5p_pred_CSS_null_norm_%s_nonzero as
    ...
    cursor.execute("""Drop view if exists chao_draft.union_m5p_pred_view;""")
    mydb.commit()
    cursor.execute("""Create view chao_draft.union_m5p_pred_view as
                ...
                FROM chao_draft.rank_m5p_pred_CSS_null_norm_2001_notie as t1,
                chao_draft.rank_m5p_pred_CSS_null_norm_2001_tied as t2,
                chao_draft.rank_m5p_pred_CSS_null_norm_2001_nonzero as t3
                where t1.id = t2.id and t1.id = t3.id
                order by t3.rank_m5p_nonzero ASC, t2.lmt_prob DESC)
                UNION
                (SELECT t1.id, t1.PlayerName, t1.DraftYear, t1.m5p_pred as m5p_pred_notie, t1.rank_m5p as rank_m5p_notie,
                t2.lmt_prob, t2.m5p_pred_tied, t2.rank_m5p_tied, t3.m5p_pred_nonzero, t3.rank_m5p_nonzero
                FROM chao_draft.rank_m5p_pred_CSS_null_norm_2002_notie as t1,
                chao_draft.rank_m5p_pred_CSS_null_norm_2002_tied as t2,
                chao_draft.rank_m5p_pred_CSS_null_norm_2002_nonzero as t3
                where t1.id = t2.id and t1.id = t3.id
                order by t3.rank_m5p_nonzero ASC, t2.lmt_prob DESC)
                UNION
                (SELECT t1.id, t1.PlayerName, t1.DraftYear, t1.m5p_pred as m5p_pred_notie, t1.rank_m5p as rank_m5p_notie,
                t2.lmt_prob, t2.m5p_pred_tied, t2.rank_m5p_tied, t3.m5p_pred_nonzero, t3.rank_m5p_nonzero
                FROM chao_draft.rank_m5p_pred_CSS_null_norm_2007_notie as t1,
                chao_draft.rank_m5p_pred_CSS_null_norm_2007_tied as t2,
                chao_draft.rank_m5p_pred_CSS_null_norm_2007_nonzero as t3
                where t1.id = t2.id and t1.id = t3.id
                order by t3.rank_m5p_nonzero ASC, t2.lmt_prob DESC)
                UNION
                (SELECT t1.id, t1.PlayerName, t1.DraftYear, t1.m5p_pred as m5p_pred_notie, t1.rank_m5p as rank_m5p_notie,
                t2.lmt_prob, t2.m5p_pred_tied, t2.rank_m5p_tied, t3.m5p_pred_nonzero, t3.rank_m5p_nonzero
                FROM chao_draft.rank_m5p_pred_CSS_null_norm_2008_notie as t1,
                chao_draft.rank_m5p_pred_CSS_null_norm_2008_tied as t2,
                chao_draft.rank_m5p_pred_CSS_null_norm_2008_nonzero as t3
                where t1.id = t2.id and t1.id = t3.id
                order by t3.rank_m5p_nonzero ASC, t2.lmt_prob DESC);""")
    mydb.commit()

    cursor.execute("""Drop view if exists chao_draft.union_all_ranks_with_m5p_view;""")
    mydb.commit()
    cursor.execute("""create view chao_draft.union_all_ranks_with_m5p_view as
                ...
                chao_draft.union_m5p_pred_view as t2              
                where t1.id = t2.id
