...
#res=0.9568965517241379
def load_unicef_data():
   
    fname_train = '/home/yejial/Desktop/data_AHL_NHL/nhl_ahl_output_training_copy.csv'
    fname_test='/home/yejial/Desktop/data_AHL_NHL/nhl_ahl_output_testing_copy.csv'
...
#train_fea_norm=values[:287,:]
#test_fea_norm=values[287:,:]
train_fea_norm=normalize_data(train_features)
test_fea_norm=normalize_data(test_features)
