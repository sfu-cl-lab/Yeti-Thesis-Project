...
age_node1 = getData.getData('1st_node1.csv',5)
gp_7y_node1 = getData.getData('1st_node1.csv',23)

age_node2 = getData.getData('1st_node2.csv',5)
gp_7y_node2 = getData.getData('1st_node2.csv',23)

age_node3 = getData.getData('1st_node3.csv',5)
gp_7y_node3 = getData.getData('1st_node3.csv',23)

age_node4 = getData.getData('1st_node4.csv',5)
gp_7y_node4 = getData.getData('1st_node4.csv',23)

age_node5 = getData.getData('1st_node5.csv',5)
...
plt.annotate(node1_top,xy=(x1_top +0.02,y1_top+10), xytext=(x1_top+2.2,y1_top+88), arrowprops = dict(facecolor='black', shrink=0.02),)
plt.axis([65,85,-10,480])
...
plt.annotate(node2_top,xy=(x2_top +0.02,y2_top+10), xytext=(x2_top+2.2,y2_top+88), arrowprops = dict(facecolor='black', shrink=0.02),)
plt.axis([65,85,-10,480])
plt.ylabel('sum_7yr_GP')
...
plt.annotate(node3_top,xy=(x3_top +0.02,y3_top+10), xytext=(x3_top+2.2,y3_top+88), arrowprops = dict(facecolor='black', shrink=0.02),)
plt.axis([65,85,-10,480])
plt.ylabel('sum_7yr_GP')
...
plt.annotate(node4_top,xy=(x4_top +0.02,y4_top+10), xytext=(x4_top+2.2,y4_top+88), arrowprops = dict(facecolor='black', shrink=0.02),)
plt.axis([65,85,-10,480])
plt.ylabel('sum_7yr_GP')
...
plt.annotate(node5_top,xy=(x5_top +0.02,y5_top+10), xytext=(x5_top+2.2,y5_top+88), arrowprops = dict(facecolor='black', shrink=0.02),)
plt.axis([65,85,-10,480])
plt.ylabel('sum_7yr_GP')
