...
age_node1 = getData.getData('2nd_node1.csv',6)
gp_7y_node1 = getData.getData('2nd_node1.csv',23)

age_node2 = getData.getData('2nd_node2.csv',6)
gp_7y_node2 = getData.getData('2nd_node2.csv',23)

age_node3 = getData.getData('2nd_node3.csv',6)
gp_7y_node3 = getData.getData('2nd_node3.csv',23)

age_node4 = getData.getData('2nd_node4.csv',6)
gp_7y_node4 = getData.getData('2nd_node4.csv',23)

age_node5 = getData.getData('2nd_node5.csv',6)
gp_7y_node5 = getData.getData('2nd_node5.csv',23)

age_node6 = getData.getData('2nd_node6.csv',6)
