...
age_node1 = getData.getData_float('2nd_node1.csv',26)
gp_7y_node1 = getData.getData('2nd_node1.csv',23)

age_node2 = getData.getData_float('2nd_node2.csv',26)
gp_7y_node2 = getData.getData('2nd_node2.csv',23)

age_node3 = getData.getData_float('2nd_node3.csv',26)
gp_7y_node3 = getData.getData('2nd_node3.csv',23)

age_node4 = getData.getData_float('2nd_node4.csv',26)
gp_7y_node4 = getData.getData('2nd_node4.csv',23)

age_node5 = getData.getData_float('2nd_node5.csv',26)
gp_7y_node5 = getData.getData('2nd_node5.csv',23)

age_node6 = getData.getData_float('2nd_node6.csv',26)
...
plt.annotate( node1_top,xy=(x1_top-0.02 ,y1_top+10), xytext=(x1_top-0.2,y1_top+66), arrowprops = dict(facecolor='black', shrink=0.02),)
plt.axis([-0.05,1.02,-10,530])
plt.ylabel('sum_7yr_GP')
plt.xlabel('lmtProb_node1')
...
plt.annotate( node2_top,xy=(x2_top ,y2_top+10), xytext=(x2_top+0.05,y2_top+66), arrowprops = dict(facecolor='black', shrink=0.02),)
plt.axis([-0.05,1.02,-10,530])
plt.ylabel('sum_7yr_GP')
plt.xlabel('lmtProb_node2')
...
plt.annotate( node3_top,xy=(x3_top,y3_top+10), xytext=(x3_top+0.05,y3_top+66), arrowprops = dict(facecolor='black', shrink=0.02),)
plt.axis([-0.05,1.02,-10,530])
plt.ylabel('sum_7yr_GP')
plt.xlabel('lmtProb_node3')
...
plt.annotate( node4_top,xy=(x4_top-0.02 ,y4_top+2), xytext=(x4_top-0.08,y4_top+66), arrowprops = dict(facecolor='black', shrink=0.02),)
plt.axis([-0.05,1.02,-10,530])
plt.ylabel('sum_7yr_GP')
plt.xlabel('lmtProb_node4')
...
plt.annotate( node5_top,xy=(x5_top,y5_top+10), xytext=(x5_top+0.05,y5_top+66), arrowprops = dict(facecolor='black', shrink=0.02),)
plt.axis([-0.05,1.02,-10,530])
plt.ylabel('sum_7yr_GP')
plt.xlabel('lmtProb_node5')

plt.subplot(2,3,6)
plt.scatter(age_node6,gp_7y_node6,s=66,facecolors='none',edgecolors='c');
plt.scatter(age_node6_top,gp_7y_node6_top,s=66,marker=r'$\bullet$',label='Fluid-Cell',facecolors='k',edgecolors='k');
plt.annotate( node6_top,xy=(x6_top-0.02,y6_top+10), xytext=(x6_top-0.1,y6_top+66), arrowprops = dict(facecolor='black', shrink=0.02),)
plt.axis([-0.05,1.02,-10,530])
plt.ylabel('sum_7yr_GP')
plt.xlabel('lmtProb_node6')
